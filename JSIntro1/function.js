function myFunctionTest(expected, found) {
  ...
  console.log("Expected output of findLongestWord(['Gizachew','Endagegnehu','Nebiyu') is Endagegnehu " + myFunctionTest("Endagegnehu",findLongestWord(["Gizachew","Endagegnehu","Nebiyu"])));
  // console.log("Expected output of findLongestWord(['Gizachew','Endagegnehu','Nebiyu') is Endagegnehu" + myFunctionTest("Endagegnehu",findLongestWord(["Gizachew","Endagegnehu","Nebiyu"])));
  ...
  console.log("Expected output of filterLongWords(['Gizachew','Nebiyu','Endagegnehu','Alex']) is ['Gizachew','Endagegnehu'] " + myFunctionTest(["Gizachew","Endagegnehu"],filterLongWords(["Gizachew","Nebiyu","Endagegnehu","Alex"],7)));

  
/* ---------------------- From JsFiddle--------------*/
document.write("Results from JS Fiddle");
const a = [1,3,5,3,3]; 
